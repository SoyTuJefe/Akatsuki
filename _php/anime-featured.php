        ...
        <div class="row">
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="anif-block anif-block-01">
                    ...
                    <div class="anif-block-ul">
                        <ul class="ulclear">
                            <?php 
                                $json = file_get_contents("$api/season/fall-2022-anime");
                    ...
                    <div class="more"><a href="/sub-category/fall-2022-anime">View more <i
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="anif-block anif-block-01">
                    ...
                    <ul class="ulclear">
                            <?php 
                                $json = file_get_contents("$api/season/summer-2023-anime");
                                $json = json_decode($json, true);
                                foreach(array_slice($json, 0, 5) as $fallAnime) { ?>
                            <li>
                                <div class="film-poster">
                                ...
                                <div class="film-detail">
                                    ...
                                    <div class="fd-infor">
                                        <span class="fdi-item">Summer 2023 </span>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                            </li>
                    ...
                    <div class="more"><a href="/sub-category/summer-2023-anime">View more <i
                                class="fas fa-angle-right ml-2"></i></a></div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="anif-block anif-block-04">
                    ...
                    <ul class="ulclear">
                            <?php 
                                $json = file_get_contents("$api/season/spring-2023-anime");
                                $json = json_decode($json, true);
                                foreach(array_slice($json, 0, 5) as $fallAnime) { ?>
                            <li>
                                <div class="film-poster">
                    ...
                    <div class="more">
                        <a href="/sub-category/spring-2023-anime">View more <i
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="anif-block anif-block-01">
                    ...
                    <ul class="ulclear">
                            <?php 
                                $json = file_get_contents("$api/season/winter-2023-anime");
                                $json = json_decode($json, true);
                                foreach(array_slice($json, 0, 5) as $fallAnime) { ?>
                            <li>
                                <div class="film-poster">
                    ...
                    <div class="more"><a href="/sub-category/winter-2023-anime">View more <i
                                class="fas fa-angle-right ml-2"></i></a></div>
                </div>
            </div>
            <div class="clearfix"></div>
