<div id="sidebar_menu">
    ...
    <ul class="nav sidebar_menu-list">
        <li class="nav-item active"><a class="nav-link" href="<?= $websiteUrl ?>/home" title="Home">
                Home</a></li>
                 <li class="nav-item active"><a class="nav-link" href="/latest/subbed" title="Subbed Anime">
                Subbed Anime</a></li>
                 <li class="nav-item active"><a class="nav-link" href="/latest/dubbed" title="Dubbed Anime">
                Dubbed Anime</a></li>
                 <li class="nav-item active"><a class="nav-link" href="/latest/chinese" title="Chinese Anime">
                Chinese Anime</a></li>
                 <li class="nav-item active"><a class="nav-link" href="/popular" title="Most Popular">
                Most Popular</a></li>
                 <li class="nav-item active"><a class="nav-link" href="/type/movies" title="Movies">
                Movies</a></li>
                 <li class="nav-item active"><a class="nav-link" href="/type/tv-series" title="TV Series">
                TV Series</a></li>
                 <li class="nav-item active"><a class="nav-link" href="/sub-category/ova" title="OVAs">
                OVAs</a></li>
                 <li class="nav-item active"><a class="nav-link" href="/sub-category/ona" title="ONAs">
                ONAs</a></li>
                 <li class="nav-item active"><a class="nav-link" href="/sub-category/special" title="Specials">
                Specials</a></li>
               
        <li class="nav-item">
            <div class="nav-link" title="Status"><strong> Status</strong></div>
                ...
                <ul class="nav color-list sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="<?= $websiteUrl ?>/genre/psychological"
                            title="Psychological">Psychological</a> </li>
                             <li class="nav-item"> <a class="nav-link" href="<?= $websiteUrl ?>/genre/reincarnation"
                            title="Romance">Reincarnation</a> </li>
...
<div id="header" class="header-home ">
    <div class="container">
        ...
        <a href="<?= $websiteUrl ?>/" id="logo" title="<?= $websiteTitle ?>">
                            ...
                            <div id="user_menu" class="dropdown-menu dropdown-menu-right">
                                ...
                                <div class="grid-menu">
                                    <a class="dropdown-item" href="<?= $websiteUrl ?>/user/profile"><i
                                            ...
                                            <a class="dropdown-item" href="<?= $websiteUrl ?>/user/continue-watching"><i
                                            class="fas fa-history mr-2"></i>Continue Watching</a>
            ...
            <div id="header_right">
                <div id="user-slot">
                    <div class="header_right-user">
                        <a href="<?= $websiteUrl ?>/user/login" class="btn-user btn btn-sm btn-primary btn-login"><i class='fas fa-user-alt'></i></a>
                    </div>
                </div>
            </div>
        <?php } ?>
