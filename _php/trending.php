    ...
    // Calculate the current week number (from 0 to 51).
    $currentWeek = intval(date('W'));

    // Calculate the seed for shuffling based on the current week.
    srand($currentWeek);
    ...
    foreach ($json as $key => $popular) {
        ...
        <div class="swiper-slide">
            <div class="item">
                ...
                <a href="/anime/<?= $popular['animeId'] ?>" class="film-poster" title="<?= $popular['animeTitle'] ?>">
