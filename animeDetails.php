    ...
    <div class="ani_detail-stage">
        <div class="container">
            <div class="anis-cover-wrap">
                <div class="anis-cover" style="background-image: url('<?=$getAnime['imageUrl']?>')"></div>
            </div>
            <div class="anis-content">
                <div class="anisc-poster">
                    <div class="film-poster">
                        <img src="<?=$websiteUrl?>/files/images/no_poster.jpg" data-src="<?=$getAnime['imageUrl']?>" class="lazyload film-poster-img">
                    </div>
                </div>
                <div class="anisc-detail">
                    <div class="prebreadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem" class="breadcrumb-item dynamic-name" data-jname="<?=$getAnime['name']?>" aria-current="page">
                    ...
                    <h2 class="film-name dynamic-name" data-jname="<?=$getAnime['name']?>">
                        <?php if (!empty($getAnime['romanji_name'])): ?>
                            <?=$getAnime['name']?> (<?=$getAnime['romanji_name']?>)
                        <?php else: ?>
                            <?=$getAnime['name']?>
                        <?php endif; ?>
                    </h2>
                    ...
                    <?php if(count($getAnime['episode_id']) == 0) {
                        ...
                        <div class="film-buttons">
                            <?php foreach (array_slice($episodelist, 0, 1) as $episode1) { ?>
                                <a href="/watch/<?= $episode1['episodeId'] ?>" class="btn btn-radius btn-primary btn-play">
