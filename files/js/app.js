("function" == typeof define && define.amd ? define : function(e, t) {
    ...
    return function() {
        function v(e, t) {
            return e = e || b(),
            (y = T("#" + e.containerId)).length || t && (e = e,
            (y = T("<div/>").attr("id", e.containerId).addClass(e.positionClass)).appendTo(T(e.target))),
            y
        }
        function s(e, t, i) {
            i = !(!i || !i.force) && i.force;
        ...
        function a(t) {
                ...
                function() {
                    {
                        var e;
                        t.title && (e = t.title,
                        r.escapeHtml && (e = i(t.title)),
                        h.append(e).addClass(r.titleClass),
                        d.append(h))
                    }
                }(),
                function() {
                    {
                        ...
                        r.escapeHtml && (e = i(t.message)),
                        c.append(e).addClass(r.messageClass),
                        d.append(c))
                    }
                }(),
                r.closeButton && (u.addClass(r.closeClass).attr("role", "button"),
                d.prepend(u)),
                r.progressBar && (p.addClass(r.progressClass),
                d.prepend(p)),
            ...
            function a() {
                (0 < r.timeOut || 0 < r.extendedTimeOut) && (l = setTimeout(s, r.extendedTimeOut),
                m.maxHideTime = parseFloat(r.extendedTimeOut),
            ...
            if (void 0 !== t.optionsOverride && (r = T.extend(r, t.optionsOverride),
            ...
            !function(e, t) {
                ...
                0 < r.timeOut && (l = setTimeout(s, r.timeOut),
                m.maxHideTime = parseFloat(r.timeOut),
                m.hideEta = (new Date).getTime() + m.maxHideTime,
                r.progressBar && (m.intervalId = setInterval(function() {
        ...
        function w(e) {
            ...
            e = null,
            0 === y.children().length && (y.remove(),
            x = void 0))
        }
        var y, t, x, E = 0, n = "error", r = "info", o = "success", l = "warning", e = {
            clear: function(e, t) {
                var i = b();
                y || v(i),
                s(e, i, t) || function(e) {
                    for (var t = y.children(), i = t.length - 1; 0 <= i; i--)
                        s(T(t[i]), e)
                }(i)
            },
            remove: function(e) {
...
function(e) {
    var t = function(s, p, n) {
        ...
        function v(e, t) {
            var i;
            !ee && (i = s.picturefill || m.pf) ? (t && t.src && !e[ie]("srcset") && e.setAttribute("srcset", t.src),
            i({
                reevaluate: !0,
                elements: [e]
            })) : t && t.src && (e.src = t.src)
        ...
        Se), ue = (A = /^img$/i,
        H = /^iframe$/i,
        B = "onscroll"in s && !/(gle|ing)bot/.test(navigator.userAgent),
        V = -1,
        k = we,
        L = G = N = 0,
        I = m.throttleDelay,
        ...
        W = e(function(t, e, i, s, a) {
            var n, r, o, l, d;
            (o = f(t, "lazybeforeunveil", e)).defaultPrevented || (s && (i ? h(t, m.autosizesClass) : t.setAttribute("sizes", s)),
            n = t[ie](m.srcsetAttr),
            i = t[ie](m.srcAttr),
            a && (r = (d = t.parentNode) && oe.test(d.nodeName || "")),
            l = e.firesLoad || "src"in t && (n || i || r),
            o = {
                target: t
            },
            h(t, m.loadingClass),
            ...
            y = ae(ge, 2500),
            ce(t, Y, !0)),
            r && he.call(d.getElementsByTagName("source"), Ee),
            n ? t.setAttribute("srcset", n) : i && !r && (H.test(t.nodeName) ? (s = i,
            0 == (d = (e = t).getAttribute("data-load-mode") || m.iframeLoadMode) ? e.contentWindow.location.replace(s) : 1 == d && (e.src = s)) : t.src = i),
            a && (n || r) && v(t, {
                src: i
            })),
        ...
        ,
        {
            _: function() {
                ...
                s.MutationObserver ? new MutationObserver(F).observe(J, {
                    ...
                    subtree: !0,
                    attributes: !0
                }) : (J[te]("DOMNodeInserted", F, !0),
                J[te]("DOMAttrModified", F, !0),
                setInterval(F, 999)),
                se("hashchange", F, !0),
                ["focus", "mouseover", "click", "load", "transitionend", "animationend"].forEach(function(e) {
                    p[te](e, F, !0)
                }),
                /d$|^c/.test(p.readyState) ? j() : (se("load", j),
                p[te]("DOMContentLoaded", F),
                ae(j, 2e4)),
                u.elements.length ? (we(),
                pe._lsFlush()) : F()
            },
            ...
            unveil: R = function(e) {
                var t, i, s, a;
                e._lazyRace || (!(a = "auto" == (s = (i = A.test(e.nodeName)) && (e[ie](m.sizesAttr) || e[ie]("sizes")))) && w || !i || !e[ie]("src") && !e.srcset || e.complete || r(e, m.errorClass) || !r(e, m.lazyClass)) && (t = f(e, "lazyunveilread").detail,
                a && me.updateElem(e, !0, e.offsetWidth),
                e._lazyRace = !0,
                G++,
                W(e, t, a, s, i))
            }
            ...
            oe.test(t.nodeName || ""))
                for (n = 0,
                r = (a = t.getElementsByTagName("source")).length; n < r; n++)
                    a[n].setAttribute("sizes", s);
        ...
        }),
        {
            ...
            !fe.i && p.getElementsByClassName && (fe.i = !0,
            me._(),
            ue._())
        };
        function ve(e, t, i) {
        ...
        function we() {
            var e, t, i, s, a, n, r, o, l, d, h, c = u.elements;
            if ((x = m.loadMode) && G < 8 && (e = c.length)) {
                for (t = 0,
                V++; t < e; t++)
                    if (c[t] && !c[t]._lazyRace)
                        if (!B || u.prematureUnveil && u.prematureUnveil(c[t]))
                            R(c[t]);
                        else if ((r = c[t][ie]("data-expand")) && (a = +r) || (a = N),
                        l || (l = !m.expand || m.expand < 1 ? 500 < J.clientHeight && 500 < J.clientWidth ? 500 : 370 : m.expand,
                        d = (u._defEx = l) * m.expFactor,
                        h = m.hFac,
                        $ = null,
                        N < d && G < 1 && 2 < V && 2 < x && !p.hidden ? (N = d,
                        V = 0) : N = 1 < x && 1 < V && G < 6 ? l : 0),
                        o !== a && (E = innerWidth + a * h,
                        T = innerHeight + a,
                        n = -1 * a,
                        o = a),
                        d = c[t].getBoundingClientRect(),
                        (z = d.bottom) >= n && (C = d.top) <= T && (M = d.right) >= n * h && (S = d.left) <= E && (z || M || S || C) && (m.loadHidden || be(c[t])) && (w && G < 3 && !r && (x < 3 || V < 4) || function(e, t) {
                            var i, s = e, a = be(e);
                            for (C -= t,
                            z += t,
                            S -= t,
                            M += t; a && (s = s.offsetParent) && s != p.body && s != J; )
                                (a = 0 < (g(s, "opacity") || 1)) && "visible" != g(s, "overflow") && (i = s.getBoundingClientRect(),
                                a = M > i.left && S < i.right && z > i.top - 1 && C < i.bottom + 1);
                            return a
                        }(c[t], a))) {
                            if (R(c[t]),
                            s = !0,
                            ...
                            !s && w && !i && G < 4 && V < 4 && 2 < x && (b[0] || m.preloadAfterLoad) && (b[0] || !r && (z || M || S || C || "auto" != c[t][ie](m.sizesAttr))) && (i = b[0] || c[t]);
                i && !s && R(i)
            }
        }
        function ye() {
        ...
        function Se(e, t) {
            _ && !t ? e.apply(this, arguments) : (Z.push(e),
            U || (U = !0,
            (p.hidden ? ae : ne)(Ce)))
        }
        return ae(function() {
...
function(e, t) {
        ...
        if (e)
            if ("string" == typeof e) {
                ...
                if (0 <= r.indexOf("<") && 0 <= r.indexOf(">")) {
                    ...
                    (n = c.createElement(o)).innerHTML = r,
                    s = 0; s < n.childNodes.length; s += 1)
                        i.push(n.childNodes[s])
                } else
                    for (a = t || "#" !== e[0] || e.match(/[ .<>:~]/) ? (t || c).querySelectorAll(e.trim()) : [c.getElementById(e.trim().split("#")[1])],
                    s = 0; s < a.length; s += 1)
                        a[s] && i.push(a[s])
            } else if (e.nodeType || e === j || e === c)
                i.push(e);
    ...
    var t = {
        ...
        off: function() {
            ...
            for (var n = n || !1, r = i.split(" "), o = 0; o < r.length; o += 1)
                for (var l = r[o], d = 0; d < this.length; d += 1) {
                    var h = this[d]
                      , c = void 0;
                    if (!s && h.dom7Listeners ? c = h.dom7Listeners[l] : s && h.dom7LiveListeners && (c = h.dom7LiveListeners[l]),
                    c && c.length)
        ...
        parent: function(e) {
            for (var t = [], i = 0; i < this.length; i += 1)
                null === this[i].parentNode || e && !E(this[i].parentNode).is(e) || t.push(this[i].parentNode);
            return E(n(t))
        },
        parents: function(e) {
            for (var t = [], i = 0; i < this.length; i += 1)
        ...
        children: function(e) {
            for (var t = [], i = 0; i < this.length; i += 1)
                for (var s = this[i].childNodes, a = 0; a < s.length; a += 1)
                    e ? 1 === s[a].nodeType && E(s[a]).is(e) && t.push(s[a]) : 1 === s[a].nodeType && t.push(s[a]);
            return new l(n(t))
        },
        filter: function(e) {
            for (var t = [], i = 0; i < this.length; i += 1)
    ...
    var _ = {
        ...
        getTranslate: function(e, t) {
            ...
            a = new j.WebKitCSSMatrix("none" === s ? "" : s)) : i = (a = e.MozTransform || e.OTransform || e.MsTransform || e.msTransform || e.transform || e.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","),
        ...
        parseUrlQuery: function(e) {
            var t, i, s, a, n = {}, e = e || j.location.href;
    ...
    var o, d, h, p, u, m, f, v, g, b, w, x, T = {
        ...
        updateSlides: function() {
            ...
            var f, v = this.snapGrid.length, n = this.snapGrid.length, g = t.spaceBetween, b = -u, w = 0, y = 0;
            if (void 0 !== i) {
                ...
                1 < t.slidesPerColumn && (f = Math.floor(l / t.slidesPerColumn) === l / this.params.slidesPerColumn ? l : Math.ceil(l / t.slidesPerColumn) * t.slidesPerColumn,
                ...
                for (var x, E, T, C, S = t.slidesPerColumn, M = f / S, z = Math.floor(l / t.slidesPerColumn), $ = 0; $ < l; $ += 1) {
                    D = 0;
                    var k, P, L, I, O, D, A, H, B, N, G, V, F = o.eq($);
                    1 < t.slidesPerColumn && (O = I = L = void 0,
                    "row" === t.slidesPerColumnFill && 1 < t.slidesPerGroup ? (V = Math.floor($ / (t.slidesPerGroup * t.slidesPerColumn)),
                    k = $ - t.slidesPerColumn * t.slidesPerGroup * V,
                    P = 0 === V ? t.slidesPerGroup : Math.min(Math.ceil((l - V * S * t.slidesPerGroup) / S), t.slidesPerGroup),
                    L = (I = k - (O = Math.floor(k / P)) * P + V * t.slidesPerGroup) + O * f / S,
                    F.css({
                        ...
                        "-webkit-order": L,
                        order: L
                    })) : "column" === t.slidesPerColumnFill ? (O = $ - (I = Math.floor($ / S)) * S,
                    (z < I || I === z && O === S - 1) && (O += 1) >= S && (O = 0,
                    I += 1)) : I = $ - (O = Math.floor($ / M)) * M,
                    F.css("margin-" + (this.isHorizontal() ? "top" : "left"), 0 !== O && t.spaceBetween && t.spaceBetween + "px")),
                    "none" !== F.css("display") && ("auto" === t.slidesPerView ? (V = j.getComputedStyle(F[0], null),
                    L = F[0].style.transform,
                    I = F[0].style.webkitTransform,
                    L && (F[0].style.transform = "none"),
                    I && (F[0].style.webkitTransform = "none"),
                    D = t.roundLengths ? this.isHorizontal() ? F.outerWidth(!0) : F.outerHeight(!0) : this.isHorizontal() ? (A = parseFloat(V.getPropertyValue("width")),
                    H = parseFloat(V.getPropertyValue("padding-left")),
                    B = parseFloat(V.getPropertyValue("padding-right")),
                    N = parseFloat(V.getPropertyValue("margin-left")),
                    G = parseFloat(V.getPropertyValue("margin-right")),
                    (O = V.getPropertyValue("box-sizing")) && "border-box" === O ? A + N + G : A + H + B + N + G) : (A = parseFloat(V.getPropertyValue("height")),
                    H = parseFloat(V.getPropertyValue("padding-top")),
                    B = parseFloat(V.getPropertyValue("padding-bottom")),
                    N = parseFloat(V.getPropertyValue("margin-top")),
                    G = parseFloat(V.getPropertyValue("margin-bottom")),
                    (V = V.getPropertyValue("box-sizing")) && "border-box" === V ? A + N + G : A + H + B + N + G),
                    L && (F[0].style.transform = L),
                    I && (F[0].style.webkitTransform = I),
                    t.roundLengths && (D = Math.floor(D))) : (D = (i - (t.slidesPerView - 1) * g) / t.slidesPerView,
                    t.roundLengths && (D = Math.floor(D)),
                    o[$] && (this.isHorizontal() ? o[$].style.width = D + "px" : o[$].style.height = D + "px")),
                    o[$] && (o[$].swiperSlideSize = D),
                    c.push(D),
                    t.centeredSlides ? (b = b + D / 2 + w / 2 + g,
                    0 === w && 0 !== $ && (b = b - i / 2 - g),
                    0 === $ && (b = b - i / 2 - g),
                    Math.abs(b) < .001 && (b = 0),
                    ...
                    (y - Math.min(this.params.slidesPerGroupSkip, y)) % this.params.slidesPerGroup == 0 && d.push(b),
                    h.push(b),
                    b = b + D + g),
                ...
                1 < t.slidesPerColumn && (this.virtualSize = (D + t.spaceBetween) * f,
        ...
        updateSlidesProgress: function(e) {
            ...
            if (0 !== i.length) {
                ...
                for (var n = 0; n < i.length; n += 1) {
                    ...
                    (t.watchSlidesVisibility || t.centeredSlides && t.autoHeight) && (o = (r = -(a - l.swiperSlideOffset)) + this.slidesSizesGrid[n],
        ...
        updateActiveIndex: function(e) {
            ...
            (this.initialized || this.params.runCallbacksOnInit) && this.emit("slideChange")) : a !== o && (this.snapIndex = a,
            this.emit("snapIndexChange"))
        },
        ...
        slideTo: function(e, t, i, s) {
            ...
            if (r.cssMode) {
                ...
                0 !== t && p.scrollTo ? p.scrollTo(((c = {})[h ? "left" : "top"] = r,
                c.behavior = "smooth",
                c)) : p[h ? "scrollLeft" : "scrollTop"] = r,
                !0
            }
        ...
        slidePrev: function(e, t, i) {
            ...
            var d, h = l(o ? this.translate : -this.translate), o = n.map(l), c = (r.map(l),
            n[o.indexOf(h)],
            n[o.indexOf(h) - 1]);
    ...
    v = !m && o.match(/(iPhone\sOS|iOS)\s([\d_]+)/),
    g = 0 <= o.indexOf("MSIE ") || 0 <= o.indexOf("Trident/"),
    b = 0 <= o.indexOf("Edge/"),
    w = 0 <= o.indexOf("Gecko/") && 0 <= o.indexOf("Firefox/"),
    e = "Win32" === x,
    r = 0 <= o.toLowerCase().indexOf("electron"),
    x = "MacIntel" === x,
    !m && x && y.touch && (1024 === h && 1366 === p || 834 === h && 1194 === p || 834 === h && 1112 === p || 768 === h && 1024 === p) && (m = o.match(/(Version)\/([\d.]+)/),
    x = !1),
    d.ie = g,
    d.edge = b,
    d.firefox = w,
    ...
    d.osVersion = u[2],
    d.android = !0,
    d.androidChrome = 0 <= o.toLowerCase().indexOf("chrome")),
    (m || v || f) && (d.os = "ios",
    d.ios = !0),
    v && !f && (d.osVersion = v[2].replace(/_/g, "."),
    d.iphone = !0),
    m && (d.osVersion = m[2].replace(/_/g, "."),
    d.ipad = !0),
    f && (d.osVersion = f[3] ? f[3].replace(/_/g, ".") : null,
    d.ipod = !0),
    d.ios && d.osVersion && 0 <= o.indexOf("Version/") && "10" === d.osVersion.split(".")[0] && (d.osVersion = o.toLowerCase().split("version/")[1].split(" ")[0]),
    d.webView = !(!(v || m || f) || !o.match(/.*AppleWebKit(?!.*Safari)/i) && !j.navigator.standalone) || j.matchMedia && j.matchMedia("(display-mode: standalone)").matches,
    d.webview = d.webView,
    d.standalone = d.webView,
    d.desktop = !(d.ios || d.android) || r,
    d.desktop && (d.electron = r,
    d.macos = x,
    d.windows = e,
    d.macos && (d.os = "macos"),
    d.windows && (d.os = "windows")),
    d.pixelRatio = j.devicePixelRatio || 1,
    d);
    function P() {
    ...
    var O = {
      ...
      , D = {
        ...
        events: {
            attachEvents: function() {
                ...
                this.onTouchStart = function(e) {
                    ...
                    this.animating && o.preventInteractionOnTransition || (i = E((t = (t = e).originalEvent ? t.originalEvent : t).target),
                    ...
                    a && (s <= e || s >= j.screen.width - e) || (_.extend(r, {
                        isTouched: !0,
                        isMoved: !1,
                    ...
                    c.activeElement && E(c.activeElement).is(r.formElements) && c.activeElement !== i[0] && c.activeElement.blur(),
                        ...
                        if (!t.isTouchEvent || "touchmove" === n.type) {
                            ...
                            if (t.isTouchEvent && i.touchReleaseOnEdges && !i.loop)
                                if (this.isVertical()) {
                                    ...
                                    return;
                            if (t.isTouchEvent && c.activeElement && n.target === c.activeElement && E(n.target).is(t.formElements))
                                return t.isMoved = !0,
                ...
                this.onTouchEnd = function(e) {
                    ...
                    var h, c = _.now(), e = c - i.touchStartTime;
                    if (t.allowClick && (t.updateClickedSlide(d),
                    t.emit("tap click", d),
                    e < 300 && c - i.lastClickTime < 300 && t.emit("doubleTap doubleClick", d)),
                    ...
                    !s.cssMode)
                        if (s.freeMode)
                            if (h < -t.minTranslate())
                                ...
                                if (s.freeModeMomentum) {
                                    ...
                                    var p = 1e3 * s.freeModeMomentumRatio
                                      ...
                                      , m = t.translate + u;
                                    n && (m = -m);
                                    var f, v, g = !1, u = 20 * Math.abs(t.velocity) * s.freeModeMomentumBounceRatio;
                                    if (m < t.maxTranslate())
                                        s.freeModeMomentumBounce ? (m + t.maxTranslate() < -u && (m = t.maxTranslate() - u),
                                        f = t.maxTranslate(),
                                        i.allowMomentumBounce = g = !0) : m = t.maxTranslate(),
                                        s.loop && s.centeredSlides && (v = !0);
                                    else if (m > t.minTranslate())
                                        s.freeModeMomentumBounce ? (m - t.minTranslate() > u && (m = t.minTranslate() + u),
                                        f = t.minTranslate(),
                                        i.allowMomentumBounce = g = !0) : m = t.minTranslate(),
                                        s.loop && s.centeredSlides && (v = !0);
                                    ...
                                    0 !== t.velocity)
                                        p = n ? Math.abs((-m - t.translate) / t.velocity) : Math.abs((m - t.translate) / t.velocity),
                                    ...
                                    s.freeModeMomentumBounce && g ? (t.updateProgress(f),
                                    t.setTransition(p),
                                    t.setTranslate(m),
                            ...
                            for (var y = 0, x = t.slidesSizesGrid[0], E = 0; E < o.length; E += E < s.slidesPerGroupSkip ? 1 : s.slidesPerGroup) {
                                ...
                                void 0 !== o[E + T] ? h >= o[E] && h < o[E + T] && (x = o[(y = E) + T] - o[E]) : h >= o[E] && (y = E,
                                x = o[o.length - 1] - o[o.length - 2])
                            }
                            g = (h - o[y]) / x,
                            p = y < s.slidesPerGroupSkip - 1 ? 1 : s.slidesPerGroup;
                            e > s.longSwipesMs ? s.longSwipes ? ("next" === t.swipeDirection && (g >= s.longSwipesRatio ? t.slideTo(y + p) : t.slideTo(y)),
                            "prev" === t.swipeDirection && (g > 1 - s.longSwipesRatio ? t.slideTo(y + p) : t.slideTo(y))) : t.slideTo(t.activeIndex) : s.shortSwipes ? !t.navigation || d.target !== t.navigation.nextEl && d.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(y + p),
                            "prev" === t.swipeDirection && t.slideTo(y)) : d.target === t.navigation.nextEl ? t.slideTo(y + p) : t.slideTo(y) : t.slideTo(t.activeIndex)
                        }
                }
                .bind(this),
                ...
                c.addEventListener(t.move, this.onTouchMove, n),
                c.addEventListener(t.end, this.onTouchEnd, !1)) : (y.touch && (a = !("touchstart" !== t.start || !y.passiveListener || !e.passiveListeners) && {
                    passive: !0,
                    capture: !1
                },
                ...
                L || (c.addEventListener("touchstart", I),
                L = !0)),
                (e.simulateTouch && !k.ios && !k.android || e.simulateTouch && !y.touch && k.ios) && (i.addEventListener("mousedown", this.onTouchStart, !1),
                c.addEventListener("mousemove", this.onTouchMove, n),
            ...
            detachEvents: function() {
                ...
                c.removeEventListener(i.move, this.onTouchMove, n),
                c.removeEventListener(i.end, this.onTouchEnd, !1)) : (y.touch && (e = !("onTouchStart" !== i.start || !y.passiveListener || !t.passiveListeners) && {
                    passive: !0,
                    capture: !1
                },
                ...
                (t.simulateTouch && !k.ios && !k.android || t.simulateTouch && !y.touch && k.ios) && (s.removeEventListener("mousedown", this.onTouchStart, !1),
                c.removeEventListener("mousemove", this.onTouchMove, n),
        ...
        breakpoints: {
            setBreakpoint: function() {
                ...
                !d || d && 0 === Object.keys(d).length || (s = this.getBreakpoint(d)) && this.currentBreakpoint !== s && ((a = s in d ? d[s] : void 0) && ["slidesPerView", "spaceBetween", "slidesPerGroup", "slidesPerGroupSkip", "slidesPerColumn"].forEach(function(e) {
                    var t = a[e];
        ...
        images: {
            loadImage: function(e, t, i, s, a, n) {
                ...
                !(E(e).parent("picture")[0] || e.complete && a) && t ? ((a = new j.Image).onload = r,
                a.onerror = r,
                s && (a.sizes = s),
                i && (a.srcset = i),
                t && (a.src = t)) : r()
      ...
      , H = function(d) {
        function h() {
            for (var i, e = [], t = arguments.length; t--; )
                e[t] = arguments[t];
            i = 1 === e.length && e[0].constructor && e[0].constructor === Object ? e[0] : (r = e[0],
            e[1]),
            i = _.extend({}, i = i || {}),
            r && !i.el && (i.el = r),
            d.call(this, i),
            ...
            if (r = o[0]) {
                ...
                _.extend(s, {
                    ...
                    touchEvents: (r = ["mousedown", "mousemove", "mouseup"],
                    y.pointerEvents && (r = ["pointerdown", "pointermove", "pointerup"]),
                    s.touchEventsTouch = {
      ...
      , G = {
        update: function(e) {
            ...
            if (e)
                ...
                for (var x = h; x <= c; x += 1)
                    (x < f || v < x) && t.$wrapperEl.find("." + t.params.slideClass + '[data-swiper-slide-index="' + x + '"]').remove();
            for (var E = 0; E < p.length; E += 1)
                f <= E && E <= v && (void 0 === c || e ? y.push(E) : (c < E && y.push(E),
                E < h && w.push(E)));
      ...
      , V = {
        ...
        enable: function() {
            this.keyboard.enabled || (E(c).on("keydown", this.keyboard.handle),
            this.keyboard.enabled = !0)
        },
        disable: function() {
            this.keyboard.enabled && (E(c).off("keydown", this.keyboard.handle),
      ...
      , F = {
        ...
        recentWheelEvents: [],
        event: function() {
            return -1 < j.navigator.userAgent.indexOf("firefox") ? "DOMMouseScroll" : ((t = "onwheel"in c) || ((e = c.createElement("div")).setAttribute("onwheel", "return;"),
            t = "function" == typeof e.onwheel),
            (t = !t && c.implementation && c.implementation.hasFeature && !0 !== c.implementation.hasFeature("", "") ? c.implementation.hasFeature("Events.wheel", "3.0") : t) ? "wheel" : "mousewheel");
            var e, t
        },
        ...
        handle: function(e) {
            ...
            if (s.forceToAxis)
                ...
                n = Math.abs(a.pixelX) > Math.abs(a.pixelY) ? -a.pixelX * r : -a.pixelY;
            if (0 === n)
                return !0;
            if (s.invert && (n = -n),
            i.params.freeMode) {
                ...
                if (!a) {
                    ...
                    var l, d, h = i.getTranslate() + n * s.sensitivity, r = i.isBeginning, s = i.isEnd;
                    if ((h = h >= i.minTranslate() ? i.minTranslate() : h) <= i.maxTranslate() && (h = i.maxTranslate()),
                    i.setTransition(0),
                    i.setTranslate(h),
                    i.updateProgress(),
                    i.updateActiveIndex(),
                    ...
                    s = l[0],
                    l.push(o),
                    r && (o.delta > r.delta || o.direction !== r.direction) ? l.splice(0) : 15 <= l.length && o.time - s.time < 500 && 1 <= s.delta - o.delta && o.delta <= 6 && (d = 0 < n ? .8 : .2,
                ...
                if (n.push(h),
                (!e || h.direction !== e.direction || h.delta > e.delta || h.time > e.time + 150) && i.mousewheel.animateSlider(h),
        ...
        animateSlider: function(e) {
            return 6 <= e.delta && _.now() - this.mousewheel.lastScrollTime < 60 || (e.direction < 0 ? this.isEnd && !this.params.loop || this.animating || (this.slideNext(),
        ...
        update: function() {
            ...
            if (s.el && this.pagination.el && this.pagination.$el && 0 !== this.pagination.$el.length) {
                ...
                "bullets" === s.type && this.pagination.bullets && 0 < this.pagination.bullets.length) {
                    var r, o, l, d, h, c = this.pagination.bullets;
                    if (s.dynamicBullets && (this.pagination.bulletSize = c.eq(0)[this.isHorizontal() ? "outerWidth" : "outerHeight"](!0),
                    ...
                    l = ((o = r + (Math.min(c.length, s.dynamicMainBullets) - 1)) + r) / 2),
                    ...
                    1 < i.length)
                        ...
                        var p = c.eq(a)
                          , u = p.index();
                        if (p.addClass(s.bulletActiveClass),
                        s.dynamicBullets) {
                            for (var t = c.eq(r), p = c.eq(o), m = r; m <= o; m += 1)
                                c.eq(m).addClass(s.bulletActiveClass + "-main");
                            if (this.params.loop)
                                if (u >= c.length - s.dynamicMainBullets) {
                                    for (var f = s.dynamicMainBullets; 0 <= f; --f)
                                        c.eq(c.length - f).addClass(s.bulletActiveClass + "-main");
                    ...
                    s.dynamicBullets && (h = Math.min(c.length, s.dynamicMainBullets + 4),
                    d = (this.pagination.bulletSize * h - this.pagination.bulletSize) / 2 - l * this.pagination.bulletSize,
                    h = e ? "right" : "left",
                    c.css(this.isHorizontal() ? h : "top", d + "px"))
                }
      ...
      , W = {
        ...
        init: function() {
            ...
            0 === (s = (i = this.params.uniqueNavElements && "string" == typeof t.el && 1 < i.length && 1 === s.find(t.el).length ? s.find(t.el) : i).find("." + this.params.scrollbar.dragClass)).length && (s = E('<div class="' + this.params.scrollbar.dragClass + '"></div>'),
            i.append(s)),
            _.extend(e, {
                $el: i,
                el: i[0],
      ...
      , q = {
        ...
        onGestureStart: function(e) {
            ...
            s.$slideEl && s.$slideEl.length || (s.$slideEl = E(e.target).closest("." + this.params.slideClass),
        ...
        onGestureEnd: function(e) {
            ...
            if (!y.gestures) {
                if (!i.fakeGestureTouched || !i.fakeGestureMoved)
                    return;
                if ("touchend" !== e.type || "touchend" === e.type && e.changedTouches.length < 2 && !k.android)
                    return;
        ...
        onTouchStart: function(e) {
            var t = this.zoom
              , i = t.gesture
              , t = t.image;
            i.$imageEl && 0 !== i.$imageEl.length && (t.isTouched || (k.android && e.cancelable && e.preventDefault(),
            t.isTouched = !0,
        ...
        in: function(e) {
            ...
            r.$slideEl || (this.params.virtual && this.params.virtual.enabled && this.virtual ? r.$slideEl = this.$wrapperEl.children("." + this.params.slideActiveClass) : r.$slideEl = this.slides.eq(this.activeIndex),
        ...
        enable: function() {
            ...
            y.gestures ? (this.$wrapperEl.on("gesturestart", i, s.onGestureStart, e),
            this.$wrapperEl.on("gesturechange", i, s.onGestureChange, e),
            this.$wrapperEl.on("gestureend", i, s.onGestureEnd, e)) : "touchstart" === this.touchEvents.start && (this.$wrapperEl.on(this.touchEvents.start, i, s.onGestureStart, e),
        ...
        disable: function() {
            ...
            i = "." + this.params.slideClass,
            y.gestures ? (this.$wrapperEl.off("gesturestart", i, s.onGestureStart, e),
            this.$wrapperEl.off("gesturechange", i, s.onGestureChange, e),
            this.$wrapperEl.off("gestureend", i, s.onGestureEnd, e)) : "touchstart" === this.touchEvents.start && (this.$wrapperEl.off(this.touchEvents.start, i, s.onGestureStart, e),
      ...
      , U = {
        loadInSlide: function(e, l) {
            void 0 === l && (l = !0);
            var d, h = this, c = h.params.lazy;
            void 0 !== e && 0 !== h.slides.length && (e = (d = h.virtual && h.params.virtual.enabled ? h.$wrapperEl.children("." + h.params.slideClass + '[data-swiper-slide-index="' + e + '"]') : h.slides.eq(e)).find("." + c.elementClass + ":not(." + c.loadedClass + "):not(." + c.loadingClass + ")"),
            0 !== (e = d.hasClass(c.elementClass) && !d.hasClass(c.loadedClass) && !d.hasClass(c.loadingClass) ? e.add(d[0]) : e).length && e.each(function(e, t) {
                var i = E(t);
                ...
                h.loadImage(i[0], a || s, n, r, !1, function() {
                    var e, t;
                    null == h || !h || h && !h.params || h.destroyed || (s ? (i.css("background-image", 'url("' + s + '")'),
                    i.removeAttr("data-background")) : (n && (i.attr("srcset", n),
                    i.removeAttr("data-srcset")),
                    r && (i.attr("sizes", r),
                    i.removeAttr("data-sizes")),
                    o.length && o.children("source").each(function(e, t) {
                        t = E(t);
                    ...
                    h.params.loop && l && (t = d.attr("data-swiper-slide-index"),
                    d.hasClass(h.params.slideDuplicateClass) ? (e = h.$wrapperEl.children('[data-swiper-slide-index="' + t + '"]:not(.' + h.params.slideDuplicateClass + ")"),
                    h.lazy.loadInSlide(e.index(), !1)) : (t = h.$wrapperEl.children("." + h.params.slideDuplicateClass + '[data-swiper-slide-index="' + t + '"]'),
        ...
        load: function() {
            ...
            if (r.loadPrevNext)
                if (1 < o || r.loadPrevNextAmount && 1 < r.loadPrevNextAmount) {
                    for (var c = r.loadPrevNextAmount, r = o, p = Math.min(e + r + Math.max(c, r), a.length), c = Math.max(e - Math.max(r, c), 0), u = e + o; u < p; u += 1)
        ...
        setTranslate: function(e, t) {
            ...
            if (Array.isArray(n))
                for (var o = 0; o < n.length; o += 1)
                    n[o] !== t && n[o]instanceof H && r(n[o]);
            else
                n instanceof H && t !== n && r(n)
        },
        setTransition: function(t, e) {
            ...
            if (Array.isArray(a))
                for (i = 0; i < a.length; i += 1)
                    a[i] !== e && a[i]instanceof H && n(a[i]);
            else
                a instanceof H && e !== a && n(a)
        }
    }
      , Q = {
      ...
      , Z = {
        ...
        setHistory: function(e, t) {
            ...
            (e = j.history.state) && e.value === t || (this.params.history.replaceState ? j.history.replaceState({
                value: t
        ...
        scrollToSlide: function(e, t, i) {
            if (t)
                for (var s = 0, a = this.slides.length; s < a; s += 1) {
                    ...
                    Z.slugify(n.attr("data-history")) !== t || n.hasClass(this.params.slideDuplicateClass) || (n = n.index(),
                    this.slideTo(n, e, i))
                }
            else
                this.slideTo(0, e, i)
      ...
      , J = {
        ...
        setHash: function() {
            var e;
            this.hashNavigation.initialized && this.params.hashNavigation.enabled && (this.params.hashNavigation.replaceState && j.history && j.history.replaceState ? j.history.replaceState(null, null, "#" + this.slides.eq(this.activeIndex).attr("data-hash") || "") : (e = (e = this.slides.eq(this.activeIndex)).attr("data-hash") || e.attr("data-history"),
            c.location.hash = e || ""),
            this.emit("hashSet"))
        },
        init: function() {
      ...
      , ie = {
        setTranslate: function() {
            ...
            l.shadow && (d ? (0 === (e = i.find(".swiper-cube-shadow")).length && (e = E('<div class="swiper-cube-shadow"></div>'),
            i.append(e)),
            e.css({
                height: a + "px"
            ...
            for (var p, u = 0; u < s.length; u += 1) {
                ...
                l.slideShadows && (y = d ? m.find(".swiper-slide-shadow-left") : m.find(".swiper-slide-shadow-top"),
                x = d ? m.find(".swiper-slide-shadow-right") : m.find(".swiper-slide-shadow-bottom"),
                0 === y.length && (y = E('<div class="swiper-slide-shadow-' + (d ? "left" : "top") + '"></div>'),
                m.append(y)),
                0 === x.length && (x = E('<div class="swiper-slide-shadow-' + (d ? "right" : "bottom") + '"></div>'),
                m.append(x)),
            ...
            l.shadow && (d ? e.transform("translate3d(0px, " + (a / 2 + l.shadowOffset) + "px, " + -a / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + l.shadowScale + ")") : (p = Math.abs(c) - 90 * Math.floor(Math.abs(c) / 90),
            t = 1.5 - (Math.sin(2 * p * Math.PI / 360) / 2 + Math.cos(2 * p * Math.PI / 360) / 2),
            a = l.shadowScale,
            p = l.shadowScale / t,
            t = l.shadowOffset,
            e.transform("scale3d(" + a + ", 1, " + p + ") translate3d(0px, " + (n / 2 + t) + "px, " + -n / 2 / p + "px) rotateX(-90deg)"))),
      ...
      , se = {
        setTranslate: function() {
            for (var e = this.slides, t = this.rtlTranslate, i = 0; i < e.length; i += 1) {
                ...
                0 === s.length && (s = E('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "left" : "top") + '"></div>'),
                n.append(s)),
      ...
      , ae = {
        setTranslate: function() {
            for (var e = this.width, t = this.height, i = this.slides, s = this.$wrapperEl, a = this.slidesSizesGrid, n = this.params.coverflowEffect, r = this.isHorizontal(), o = this.translate, l = r ? e / 2 - o : t / 2 - o, d = r ? n.rotate : -n.rotate, h = n.depth, c = 0, p = i.length; c < p; c += 1) {
                ...
                0 === g.length && (g = E('<div class="swiper-slide-shadow-' + (r ? "left" : "top") + '"></div>'),
                u.append(g)),
                0 === v.length && (v = E('<div class="swiper-slide-shadow-' + (r ? "right" : "bottom") + '"></div>'),
                u.append(v)),
      ...
      , ne = {
        ...
        onThumbClick: function() {
            ...
            s && (t = s.clickedIndex,
            (e = s.clickedSlide) && E(e).hasClass(this.params.thumbs.slideThumbActiveClass) || null == t || (i = s.params.loop ? parseInt(E(s.clickedSlide).attr("data-swiper-slide-index"), 10) : t,
        ...
        update: function(e) {
            ...
            if (t) {
                var i, s, a, n = "auto" === t.params.slidesPerView ? t.slidesPerViewDynamic() : t.params.slidesPerView, r = this.params.thumbs.autoScrollOffset, o = r && !t.params.loop;
                this.realIndex === t.realIndex && !o || (i = t.activeIndex,
                ...
                o && (s += "next" === a ? r : -1 * r),
                t.visibleSlidesIndexes && t.visibleSlidesIndexes.indexOf(s) < 0 && (t.params.centeredSlides ? s = i < s ? s - Math.floor(n / 2) + 1 : s + Math.floor(n / 2) - 1 : i < s && (s = s - n + 1),
                ...
                t.params.loop || t.params.virtual && t.params.virtual.enabled)
                    ...
                    for (var c = 0; c < l; c += 1)
                        t.slides.eq(this.realIndex + c).addClass(d)
            }
        }
    }
      , S = [T, C, M, z, $, i, S, {
        ...
        on: {
            ...
            click: function(e) {
                ...
                !this.params.navigation.hideOnClick || E(e.target).is(i) || E(e.target).is(s) || (s ? t = s.hasClass(this.params.navigation.hiddenClass) : i && (t = i.hasClass(this.params.navigation.hiddenClass)),
    ...
    return void 0 === H.use && (H.use = H.Class.use,
    H.installModule = H.Class.installModule),
    H.use(S),
    H
});
var isLoggedIn = !1
  , loading = !1;
function checkLogin() {
    return isLoggedIn || $("#modallogin").modal("show"),
    isLoggedIn
}
function paginationGetData(e) {
    var t = $(e).attr("data-container");
    $(t).find(".loading-relative").show(),
    $.get($(e).attr("data-url"), function(e) {
        $(t).html(e.html),
        $(t).find(".loading-relative").hide()
    })
}
function register(e) {
    $.post("/", e, function(e) {
        $("#resister-loading").hide(),
        loading = !1,
        e.status ? (isLoggedIn = !0,
        $("#modallogin").modal("hide"),
        $("#header_right").html(e.html),
        toastr.success(e.msg, "", {
            timeout: 5e3
        })) : ($("#register-error").html(e.msg),
        $("#register-error").show())
    })
}
$.get("/", function(e) {
...
$("#register-form").submit(function(e) {
    ...
    e.preventDefault(),
    loading || (loading = !0,
    $("#resister-loading").show(),
    $("#register-error").hide(),
    t = $(this).serializeArray(),
    "undefined" != typeof grecaptcha ? grecaptcha.execute(recaptchaSiteKey, {
        action: "register"
    }).then(function(e) {
        t.push({
            name: "_token",
...
$("#forgot-form").submit(function(e) {
    ...
    $("#msg-success").hide(),
    e = $(this).serializeArray(),
    $.post("/ajax/forgot-password", e, function(e) {
        $("#loading").hide(),
        loading = !1,
        e.status ? ($("#msg-success").html(e.msg),
        $("#msg-success").show()) : ($("#msg-error").html(e.msg),
        $("#msg-error").show())
    }))
}),
