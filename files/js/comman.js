...
$(document).ready(function() {
    ...
    userSettings.anime_name !== "en" ? ($('.select-anime-name').addClass('off') && toggleAnimeName()) : $('.select-anime-name').removeClass('off');
    parseInt(userSettings.enable_dub) !== 1 ? $('.select-play-dub').removeClass('active') : $('.select-play-dub').addClass('active');
