...
<head>
    ...
    <title>Latest Subbed on <?=$websiteTitle?></title>
    
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Latest Subbed on <?=$websiteTitle?>">
    ...
    <meta property="og:title" content="Latest Subbed on <?=$websiteTitle?>">
    <meta property="og:description" content="Latest Subbed on <?=$websiteTitle?> in HD with No Ads. Watch anime online">
...
<?php 
                                $json = file_get_contents("$ani/meta/anilist/advanced-search?season=FALL&year=2023&page=$page");
                                    ...
                                    <div class="flw-item">
                                        ...
                                        <div class="film-detail">
                                            ...
                                            <div class="fd-infor">
                                                ...
                                                <span class="dot"></span>   <span class="fdi-item">FALL</span>

                          

                <span class="dot"></span>        
                                                <span class="fdi-item"><?=$recentRelease['releaseDate']?></span>
                                                <span class="dot"></span>
                                                <span class="fdi-item"><?=$recentRelease['status']?></span>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
   ...
   <nav aria-label="Page navigation">
    <ul class="pagination pagination-lg justify-content-center">
        ...
        $totalPages = 5; // Replace this with the total number of pages in your API response.
        ...
        // "First" link
        if ($currentPage > 1) {
            echo '<li class="page-item"><a title="First" class="page-link" href="/latest/upcoming?page=1">&laquo;</a></li>';
        }

        // "Previous" link
        if ($currentPage > 1) {
            echo '<li class="page-item"><a title="Previous" class="page-link" href="/latest/upcoming?page=' . ($currentPage - 1) . '">&lsaquo;</a></li>';
        }
        ...
        for ($i = $startPage; $i <= $endPage; $i++) {
            if ($i === $currentPage) {
                ...
                echo '<li class="page-item"><a title="Page ' . $i . '" class="page-link" href="/latest/upcoming?page=' . $i . '">' . $i . '</a></li>';
            }
        }

        // "Next" link
        if ($currentPage < $totalPages) {
            echo '<li class="page-item"><a title="Next" class="page-link" href="/latest/upcoming?page=' . ($currentPage + 1) . '">&rsaquo;</a></li>';
        }

        // "Last" link
        if ($currentPage < $totalPages) {
            echo '<li class="page-item"><a title="Last" class="page-link" href="/latest/upcoming?page=' . $totalPages . '">&raquo;</a></li>';
        }
        ?>
    </ul>
</nav>
