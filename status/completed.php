...
<div class="pre-pagination mt-5 mb-5">
    <nav aria-label="Page navigation">
        <ul class="pagination pagination-lg justify-content-center">
            ...
            $totalPages = 583; // Replace this with the total number of pages in your API response.
            ...
            // "First" link
            if ($currentPage > 1) {
                echo '<li class="page-item"><a title="First" class="page-link" href="/status/completed?page=1">&laquo;</a></li>';
            }

            // "Previous" link
            if ($currentPage > 1) {
                echo '<li class="page-item"><a title="Previous" class="page-link" href="/status/completed?page=' . ($currentPage - 1) . '">&lsaquo;</a></li>';
            }
            ...
            for ($i = $startPage; $i <= $endPage; $i++) {
                if ($i === $currentPage) {
                    ...
                    echo '<li class="page-item"><a title="Page ' . $i . '" class="page-link" href="/status/completed?page=' . $i . '">' . $i . '</a></li>';
                }
            }

            // "Next" link
            if ($currentPage < $totalPages) {
                echo '<li class="page-item"><a title="Next" class="page-link" href="/status/completed?page=' . ($currentPage + 1) . '">&rsaquo;</a></li>';
            }

            // "Last" link
            if ($currentPage < $totalPages) {
                echo '<li class="page-item"><a title="Last" class="page-link" href="/status/completed?page=' . $totalPages . '">&raquo;</a></li>';
            }
            ?>
        </ul>
    </nav>
